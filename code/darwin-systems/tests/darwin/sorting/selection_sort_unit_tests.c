/**
 * @file        :   selection_sort_unit_tests.c
 * @author      :   Braiden Gole
 * @brief       :   Comprehensive unit test suite for the Selection Sort algorithm.
 ...
 * Compile:
 * clang ./tests/darwin/sorting/selection_sort_unit_tests.c ./src/darwin/sorting/selection-sort/selection_sort.c ./src/unity.c -Iinclude -o ./bin/selection_sort_unit_test
 * @version     :   1.0
 * @date        :   2026-04-18
 */
#include <stdio.h>
