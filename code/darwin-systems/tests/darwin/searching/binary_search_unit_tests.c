 ...
 * @details     :   This test suite covers edge cases, boundary conditions, 
 * and typical search scenarios using the Unity Test Framework.
 * Compile:
 * clang ./tests/darwin/searching/binary_search_unit_tests.c ./src/darwin/searching/binary-search/binary_search.c ./src/unity.c -Iinclude -o ./bin/binary_search_unit_test
 * @version     :   1.0
 * @date        :   2026-04-14
 */
